...
class Sifted(Stage):
    ...
    def _run(self, opts: SiftedOptions, opts_selvars: SelvarsOptions, data_dense: Data) -> tuple[
        NDArray[np.intc],
        NDArray[np.intc],
    ...
    def sifted(
        ...
        # update feat_labels based on selected features
        ...
        if bydensity:
            ...
            # This is also data changed when filter is called
        ...
        # Preserve this to sort out where to include the data changed:
