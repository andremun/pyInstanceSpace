...
#         output_dir / "fitlibsvm_gaussian/precision.csv",
#         header=None,
#     ).values
#     recall_output = pd.read_csv(
#         output_dir / "fitlibsvm_gaussian/recall.csv",
#         header=None,
#     ).values

#     boxcosnt_output = pd.read_csv(
#         output_dir / "fitlibsvm_gaussian/boxconst.csv",
#         header=None,
#     )
#     cvcmat_output = pd.read_csv(
#         output_dir / "itlibsvm_gaussian/cvcmat.csv",
#         header=None,
#     )
#     kscale_output = pd.read_csv(
#         output_dir / "fitlibsvm_gaussian/kscale.csv",
#         header=None,
#     )
...
#         output_dir / "fitlibsvm_gaussian/pr0hat.csv",
#         header=None,
#     )
#     pr0sub_output = pd.read_csv(
#         output_dir / "fitlibsvm_gaussian/pr0sub.csv",
#         header=None,
#     )
#     selection0_output = pd.read_csv(
#         output_dir / "fitlibsvm_gaussian/selection0.csv",
#         header=None,
#     )
#     selection1_output = pd.read_csv(
#         output_dir / "fitlibsvm_gaussian/selection1.csv",
#         header=None,
#     )
...
#         output_dir / "fitlibsvm_polynomial/accuracy.csv",
#         header=None,
#     )
#     precision_output = pd.read_csv(
#         output_dir / "fitlibsvm_polynomial/precision.csv",
#         header=None,
#     )
#     recall_output = pd.read_csv(
#         output_dir / "fitlibsvm_polynomial/recall.csv",
#         header=None,
#     )
#     boxcosnt_output = pd.read_csv(
#         output_dir / "fitlibsvm_polynomial/boxconst.csv",
#         header=None,
#     )
#     cvcmat_output = pd.read_csv(
#         output_dir / "fitlibsvm_polynomial/cvcmat.csv",
#         header=None,
#     )
#     kscale_output = pd.read_csv(
#         output_dir / "fitlibsvm_polynomial/kscale.csv",
#         header=None,
#     )
#     mu_output = pd.read_csv(output_dir / "fitlibsvm_polynomial/mu.csv", header=None)
#     sigma_output = pd.read_csv(
#         output_dir / "fitlibsvm_polynomial/sigma.csv",
#         header=None,
#     )
#     pr0hat_output = pd.read_csv(
#         output_dir / "fitlibsvm_polynomial/pr0hat.csv",
#         header=None,
#     )
#     pr0sub_output = pd.read_csv(
#         output_dir / "fitlibsvm_polynomial/pr0sub.csv",
#         header=None,
#     )
#     selection0_output = pd.read_csv(
#         output_dir / "fitlibsvm_polynomial/selection0.csv",
#         header=None,
#     )
#     selection1_output = pd.read_csv(
#         output_dir / "fitlibsvm_polynomial/selection1.csv",
#         header=None,
#     )
...
def test_bayes_opt() -> None:
    ...
    # print("matlab_accuracy:" + str(matlab_accuracy))
    # print("accuracy:" + str(pythiaOut.accuracy))
    # print("matlab_precision:" + str(matlab_precision))
    # print("precision:" + str(pythiaOut.precision))
    # print("matlab_recall:" + str(matlab_recall))
    # print("recall:" + str(pythiaOut.recall))
